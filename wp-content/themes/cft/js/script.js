...
$().ready(function(){
  ...
  $('.events-slider').slick({
    ...
    cssEase: 'linear',
    swipeToSlide: true,
    prevArrow: ".events-slider-prev-arrow",
    nextArrow: ".events-slider-next-arrow",
    responsive: [
    {
      breakpoint: 1300,
      settings: {
  ...
  $('.data-visualization-slider').slick({
    infinite: false,
    loop: true,
    slidesToShow: 2.5,
    slidesToScroll: 2.5,
    ...
    cssEase: 'linear',
    swipeToSlide: true,
    prevArrow: ".dv-prev-arrow",
    nextArrow: ".dv-next-arrow",
    responsive: [
    {
      breakpoint: 1300,
      settings: {
  ...
  $('.sketch-slider').slick({
    ...
    cssEase: 'linear',
    swipeToSlide: true,
    prevArrow: ".sketch-prev-arrow",
    nextArrow: ".sketch-next-arrow",
    responsive: [
    {
      breakpoint: 1300,
      settings: {

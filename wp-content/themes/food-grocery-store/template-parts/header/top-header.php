        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 border-right text-center">
            <?php if( get_theme_mod( 'food_grocery_store_daily_deals_link') != '' || get_theme_mod( 'food_grocery_store_daily_deals_text') != ''){ ?>
              <a href="<?php echo esc_html(get_theme_mod('food_grocery_store_daily_deals_link',''));?>" ><i class="fas fa-rss me-2"></i><?php echo esc_html(get_theme_mod('food_grocery_store_daily_deals_text',''));?></a>
            <?php } ?>
          </div>
          <div class="col-lg-6 col-md-6 text-center">
            <?php if( get_theme_mod( 'food_grocery_store_contact_link') != '' || get_theme_mod( 'food_grocery_store_contact_text') != '') { ?>
              <a href="<?php echo esc_html(get_theme_mod('food_grocery_store_contact_link',''));?>" ><i class="fas fa-headphones me-2"></i><?php echo esc_html(get_theme_mod('food_grocery_store_contact_text',''));?></a>
            <?php } ?>
          </div>
        </div>
      </div>
            ...
            <?php if( get_theme_mod( 'food_grocery_store_order_tracking') != '') { ?>
              <?php if(class_exists('woocommerce')){ ?>
                <div class="order-track">
                  <span><i class="fas fa-map-marker-alt me-2"></i><?php esc_html_e('Order Tracking','food-grocery-store'); ?></span>
